...
class UserProfile(models.Model):
    ...
    address_1 = models.CharField("Address Line 1", max_length=80, blank=True, null=True)
    address_2 = models.CharField("Address Line 2", max_length=80, blank=True, null=True)
